							...
							<div class="col-sm-4">
								<div class="panel panel-primary">
									<div class="panel-body row"  style="margin-bottom: 14px;">
										...
										<hr>
										<label class="col-sm-3" for="" >Kasir</label>
										<div class="col-sm-9">
							...
							<div class="col-sm-4">
								<div class="panel panel-primary">
									<div class="panel-body row" style="margin-bottom: 14px;">
										...
										<div class="col-sm-2">
											<button class="btn btn-primary btn-block" onclick="push_cart()"><i class="fa fa-shopping-cart"></i></button>
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="panel panel-primary">
									<div class="panel-body row">
										<?php $get_no_inv = $lihat->next_invoice_no(DATE("Y-m-d")); ?>
										<input type="hidden" id="no_order" value="<?=$get_no_inv?>">
										<div class="col-sm-12"><b><u>INVOICE : <?=$get_no_inv?></u></b></div>
										<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<div class="panel panel-primary">
									<div class="panel-heading">
										<h4><i class="fa fa-shopping-cart"></i> Hasil Keranjang</h4>
									</div>
									...
									<div class="panel-footer" style="text-align:right">
										<a href="javascript:void(0)" class="btn btn-success" onclick="save_invoice()"><i class="fa fa-money" aria-hidden="true"></i> Bayar</a>
									</div>
								</div>
							</div>
				...
				<div id="ModalEdit" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content modal-lg" style=" border-radius:0px;">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" onclick="update_transaksi()">Save</button>
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
							</div>
						</div>
					</div>
...
function push_cart(){
	...
	cart_session.forEach(function(val, key){
		if(val[0]==id_barang){
			qty_total = Number(qty_total)+Number(val[7]);
		}
	});
...
function save_invoice(){
	...
	$.ajax({
		type: "POST",
		url: "fungsi/tambah/tambah.php?penjualan=yes",
		data:{
			no_order : no_order,
